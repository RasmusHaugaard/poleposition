...
def:
	...
	.equ	accWadress=0b00111000 ;Adresse til gyroen for at skrive til den. SDO = GND
	.equ	accRadress=0b00111001 ;Adresse til gyroen for at læse fra den. SDO = GND 
	.equ	accRegisterX=0b0101001 ;Register adresse for x-værdi
	.equ	accRegisterY=0b0101011 ;Register adresse for y-værdi 
	.equ	accRegisterZ=0b0101101 ;Register adresse for z-værdi
	.equ	DataVar=TWDR


.macro sendData  ;send data funktion, der sender data til bluetooth enhed og til computer. 
;Delay 160.000 clock cyklusser = 10 ms 
		delay500ms		;Tjek evt om CALL understøttes. 
...
;SAD + R - Slave adresse men nu med write data. 
adressRadress:
...
;DATA - 8 bit data fra slaven 
	...
	dataXvalue:	
		...
		in 		R16, DataVar 	;Loader vores data ind fra TWDR
 			sendData				;Funktioner der sender data til computer. 
