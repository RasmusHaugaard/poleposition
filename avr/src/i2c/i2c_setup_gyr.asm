.equ gyr_addr = 0b11010000
.equ gyr_addr_w = gyr_addr
.equ gyr_addr_r = gyr_addr + 1
...
.equ gyr_reg_ctrl3 = 0x22
.equ I2_DRDY = 3
.equ gyr_ctrl3_val = 1<<I2_DRDY
I2C_ID_WRITE [gyr_addr_w, gyr_reg_ctrl3, gyr_ctrl3_val]
